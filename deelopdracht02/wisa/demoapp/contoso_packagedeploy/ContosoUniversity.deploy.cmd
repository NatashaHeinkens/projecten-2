...
set _DeploySetParametersFile=%RootPath%ContosoUniversity.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%ContosoUniversity.zip" (
echo "%RootPath%ContosoUniversity.zip" does not exist. 
...
:usage
echo =========================================================
if not exist "%RootPath%ContosoUniversity.deploy-readme.txt" (
...
start notepad "%RootPath%ContosoUniversity.deploy-readme.txt"
)
echo =========================================================
goto :eof
