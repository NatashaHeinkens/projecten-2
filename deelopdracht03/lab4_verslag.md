###Taak 1
Keuze van apparaten: zie typenamen onder elk toestel in de topologie.

Serial interfaces toevoegen aan routers
...
Serial interfaces toevoegen aan routers
1. router uitzetten: klikken op 1/0-knop in de afbeelding van de achterkant van de router
2. module HWIC-2T toevoegen in rechterslot: sleep de module uit de lijst links naar de slot
